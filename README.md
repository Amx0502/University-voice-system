...
本软件在打开之前需要安装小皮面板([phpstudy](https://www.xp.cn/php-study))，否则将无法运行软件。在已安装小皮面板(phpstudy)的计算机上只要点击打开Apache即可运行本软件。

系统运行在浏览器中，在浏览器中输入网址即可使用。

注：数据库信息需修改为本机的mysql账号密码

![image](https://github.com/user-attachments/assets/05bfffd3-355a-48bb-ae66-9bab887331ef)

### 2 系统使用

#### 2.1 使用流程图

![image](https://github.com/user-attachments/assets/fa19357f-0607-4074-9d28-948ca5612b91)
...
![image](https://github.com/user-attachments/assets/b68ab3ab-a628-4af1-a251-753e5c34b177)
...
![image](https://github.com/user-attachments/assets/1dfa8c0c-df2a-4b13-a4a8-d77f42a7f482)

##### 2.2.3 用户首页

成功登录之后的用户页面首页

![image](https://github.com/user-attachments/assets/cda9b2f3-b3a0-411f-99f1-86b4c3f976e7)

##### 2.2.4 发表留言

登录后的用户可以发表留言，包括留言内容、选择是否设为私密（仅管理员和留言者可见）。

![image](https://github.com/user-attachments/assets/55d6f301-93d2-4253-8887-bb6e8c8549e6)

##### 2.2.5 留言点赞

用户可以对任意公开留言进行点赞操作，点赞数显示在留言旁。

![image](https://github.com/user-attachments/assets/e4f5a1b6-0ab9-4762-b40f-742f33343e45)

##### 2.2.6 留言点踩

根据系统设计，可允许用户对不喜欢的留言进行“踩”操作，以表达负面评价。

![image](https://github.com/user-attachments/assets/816e7712-8465-4de2-92a9-7c024b2d029c)

##### 2.2.7 留言举报

用户可以举报违规或不良留言。

![image](https://github.com/user-attachments/assets/7cd5b849-f8f9-4d49-a02b-c90356b00fb7)

##### 2.2.8 留言回复

用户可以对管理员的回复再次进行回复。

![image](https://github.com/user-attachments/assets/e8dbd5b3-f6f0-4d57-b9b8-df5e2a784c7b)

回复成功后会在页面显示你的回复内容，如下图所示

![image](https://github.com/user-attachments/assets/726a6b96-f06f-46b7-b98c-2493547a21d2)
...
![image](https://github.com/user-attachments/assets/955b97d3-95bf-4a94-afc6-a1535731c233)
...
![image](https://github.com/user-attachments/assets/eb1f9760-c7c5-4827-a4a1-f9d7132c7496)

##### 2.3.3 管理员首页

成功登录之后的管理员页面首页，可查看到所有用户的基本信息。

![image](https://github.com/user-attachments/assets/d17486f3-85b0-43a1-82bc-5146f7d2dbe8)

##### 2.3.4 查看私密留言

如果用户发表的留言为私密留言，则会在管理员页面有个锁来表示。

![image](https://github.com/user-attachments/assets/e0138649-b6f6-4d57-a8d0-4d932f319735)

##### 2.3.5 查看举报留言

如果用户发表的留言被人举报，则会在管理员页面显示被举报次数。

![image](https://github.com/user-attachments/assets/0a834ff2-36ff-4222-bf8d-98a9f8b788ea)

##### 2.3.6 回复/修改留言

支持对用户的留言进行回复/修改。

![image](https://github.com/user-attachments/assets/d00a6b27-f4ee-4810-bd48-b6a748516add)

![image](https://github.com/user-attachments/assets/5fd0f915-8a10-461b-8859-c87e3bdf5448)

##### 2.3.7 删除留言

管理员有权可以删除任何留言。

![image](https://github.com/user-attachments/assets/01a8d34d-cee4-4ef3-83dc-68ea69a2a965)
...
![image](https://github.com/user-attachments/assets/3722f888-666f-4886-8da4-fd616bbc310b)

#### 3.2 防止SQL注入

接收到用户提交的表单后，将进行安全处理，如果直接拼接到sql中执行，会产生严重的安全漏洞。

![image](https://github.com/user-attachments/assets/15f10614-1a6e-45e6-9b37-fb820d97be93)
